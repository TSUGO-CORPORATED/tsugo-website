                        ...
                        <div className='navbar__right'>
                            <Button onClick={avatarHandleClick}>
                                <div className='navbar__right__avatar'>
                                    <p className='navbar__right__avatar__first-name'>{userFirstName}</p>
                                    <Avatar 
                                        src={userPhotoUrl} 
                            ...
                            >
                                <MenuItem onClick={avatarHandleClose}>
                                    <Link href="/profile" className='navbar__right__avatar__profile'>
                                        <Avatar />
                                        Profile
                                    </Link>
                                </MenuItem>
                                <Divider />
                                <MenuItem onClick={avatarHandleClose}>
                                    <Link href="/dashboard" className='navbar__right__avatar__dashboard'>
                                        <ListItemIcon>
                                ...
                                <MenuItem onClick={signOutWindowHandleOpen}>
                                    <div className='navbar__right__avatar__sign-out'>
                                        <ListItemIcon>
